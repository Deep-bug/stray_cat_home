...
import 'package:stray_cat_home/util/formatter/customized_length_formatter.dart';
import 'package:stray_cat_home/util/formatter/customized_text_formatter.dart';
  ...
  OutlineInputBorder _getEditBorder(bool isEdit) {
    return OutlineInputBorder(
      ...
      borderSide: BorderSide(
        color: isEdit ? Colors.green : Colors.black12,
        width: 3,
      ),
    );
  }
