...
class JsonConvert {
  ...
  T? asT<T extends Object?>(dynamic value) {
	...
	static M? _fromJsonSingle<M>(Map<String, dynamic> json) {
		...
		if(type == (CatFarmilyListEntity).toString()){
			return CatFarmilyListEntity.fromJson(json) as M;
		}
  ...
  //list is returned by type
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		if(<CatFarmilyListEntity>[] is M){
			return data.map<CatFarmilyListEntity>((Map<String, dynamic> e) => CatFarmilyListEntity.fromJson(e)).toList() as M;
		}
