...
class StringStyles{
  ...
  static const String loginAccountPwdHint = '请输入密码';
  static const String loginAccountRePwdHint = '请再次输入密码';
  ...
  static const String registerAccountEmpty = '用户名不能为空';
  static const String registerAccountLength = '用户名长度';
  static const String registerPasswordEmpty = '密码不能为空';
  ...
  static const String catInfoPage="图鉴";
...
class Messages extends Translations{
  ...
  StringStyles.registerServiceTerms : '已阅读并同意服务条款',
      ...
      StringStyles.homeComplex : '地图',
      StringStyles.homeProject : '社区',
    ...
    'zh_HK' :{
      StringStyles.appName : 'liulangmao',
      StringStyles.catInfoPage:"图鉴",
